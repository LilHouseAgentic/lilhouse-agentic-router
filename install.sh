...
backup_existing /usr/local/bin/lilhouse-agent-proposal-review
...
install -m 0755 "$REPO_DIR/bin/lilhouse-agent-proposal-review" "$(root_path /usr/local/bin/lilhouse-agent-proposal-review)"
...
echo "  lilhouse-agent-proposal-review --json"
